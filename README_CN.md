...
<p align="center">
  支持 Claude Code、Cursor、Codex 等 35+ AI 智能体 — 任何兼容 <a href="https://github.com/nicepkg/skills">open skills</a> 生态的智能体均可使用。
</p>
...
每一页幻灯片都拥有 GSAP 驱动的动画效果。根据你的演示场景选择合适的动画强度：

- **Minimal（极简）** — 淡入淡出、平滑滑动。干净专业，适合企业汇报、商务场景，让内容本身成为主角。

- **Balanced（均衡）** — 适度的入场动效加上交错时序。增加视觉节奏但不喧宾夺主，适合产品演示和团队会议。

- **Creative（创意）** — 大胆的电影感运镜，配合滚动触发、视差效果和动态转场。专为路演、产品发布和需要震撼效果的场景打造。堪比 Awwwards 级别的动效设计。
